...
public class map00 extends maps {	//Esta clase se extiende de la clase maps
	...
	public void buildMap(World world) {		//Objetos y límites del mapa, NO MODIFICAR.
		...
		feetShape.setPosition(new Vector2(30, 10)); // 10
		feetShape.setRadius(1.5f);
		...
		feetShape1.setPosition(new Vector2(10, 30)); // 10
