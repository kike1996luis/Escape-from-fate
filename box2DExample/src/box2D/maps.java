...
public class maps {
	...
	public void chooseMap(int opcMap) { // Se escogen los mapas aqu� por
										// par�metro
		switch (opcMap) {

		case 1: // Dependiendo del mapa que se escoja, se carga la posici�n del
				// jugador en �l
	...
	public void render() { // Se renderiza el jugador y las c�maras
